...
const extractCredentials = (options)=>{
    ...
    if (s3Options?.accessKeyId && s3Options?.secretAccessKey) {
        console.warn("[upload-aws-s3] Passing 'accessKeyId' and 'secretAccessKey' directly in s3Options is deprecated. " + "Please wrap them in a 'credentials' object: s3Options: { credentials: { accessKeyId, secretAccessKey } }.");
        return {
